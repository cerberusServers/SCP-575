...
namespace SCP_575
{
    public class Config : IConfig
    {
        ...
        public float InitialDelay { get; private set; } = 210f;
        [Description("The minimum number of seconds a blackout event can last.")]
        public float DurationMin { get; private set; } = 42f;
        ...
        public float DurationMax { get; private set; } = 75f;
        [Description("The minimum amount of seconds between each event.")]
        public int DelayMin { get; private set; } = 354;
        ...
        public float KeterDamage { get; private set; } = 150f;
        ...
        public string CassieMessageEnd { get; set; } = "pitch_.49 .g2 pitch_.85 facility pitch_.95 power system pitch_1 now online";
        [Description("Broadcast shown when a player is damaged by SCP-575.")]
        public string DamageBroadcast { get; set; } = "<i>¡Fuiste deborado por el <color=red> SCP-575</color>, equipate una linterna la proxima vez!</i>";
        public ushort DamageBroadcastDuration { get; set; } = 6;
